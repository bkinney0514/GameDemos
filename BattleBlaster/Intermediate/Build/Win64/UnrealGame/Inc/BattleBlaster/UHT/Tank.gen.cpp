...
struct Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_Tank_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATank, ATank::StaticClass, TEXT("ATank"), &Z_Registration_Info_UClass_ATank, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATank), 3720689108U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_Tank_h__Script_BattleBlaster_2553182447(TEXT("/Script/BattleBlaster"),
