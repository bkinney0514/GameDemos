...
struct Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_BasePawn_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABasePawn, ABasePawn::StaticClass, TEXT("ABasePawn"), &Z_Registration_Info_UClass_ABasePawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABasePawn), 2211966205U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_BasePawn_h__Script_BattleBlaster_3126335166(TEXT("/Script/BattleBlaster"),
