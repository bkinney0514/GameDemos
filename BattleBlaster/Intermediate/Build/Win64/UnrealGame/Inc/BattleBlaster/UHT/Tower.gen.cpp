...
struct Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATower, ATower::StaticClass, TEXT("ATower"), &Z_Registration_Info_UClass_ATower, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATower), 2326258742U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_664627434(TEXT("/Script/BattleBlaster"),
