...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AShooterSamCharacter_Statics::NewProp_GunClass = { "GunClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AShooterSamCharacter, GunClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AGun_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GunClass_MetaData), NewProp_GunClass_MetaData) };
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_ShooterSam_Source_ShooterSam_ShooterSamCharacter_h__Script_ShooterSam_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterSamCharacter, AShooterSamCharacter::StaticClass, TEXT("AShooterSamCharacter"), &Z_Registration_Info_UClass_AShooterSamCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterSamCharacter), 2824547381U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_ShooterSam_Source_ShooterSam_ShooterSamCharacter_h__Script_ShooterSam_2723312013(TEXT("/Script/ShooterSam"),
	Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_ShooterSam_Source_ShooterSam_ShooterSamCharacter_h__Script_ShooterSam_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_GameDemos_ShooterSam_Source_ShooterSam_ShooterSamCharacter_h__Script_ShooterSam_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
